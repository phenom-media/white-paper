...
Основатели Phenom были убеждены, что в ближайшем будущем количество портативных, высокоточных и мультифункциональных девайсов станет больше. Особенно это будет ощутимо не столько в количественном, но в качественном количестве. 
...
![Network](/_media/network.png ":no-zoom")
...
![Nodes](/_media/nodes.png ":no-zoom")
...
![Validation](/_media/validation.png ":no-zoom")
...
Во избежание слишком высоких комиссий также введена атомная единица токена: 1 Phenom = 1000000 АТОМ. При этом, атомная частица токена, которая может быть передана в блокчейн, составляет 0.000001 PNT. Этот аналог существует также в биткоинах, WEI в ETH и других криптовалютах.
